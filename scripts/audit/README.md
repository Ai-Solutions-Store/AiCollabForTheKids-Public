...
- Verifies: `CHARITY_split === (net_revenue * 0.60)`
- Verifies: `infrastructure_split === (net_revenue * 0.30)`
- Verifies: `founder_split === (net_revenue * 0.10)`
...
[Transaction 5] ID: sq_pay_12345
  Net Revenue: $100.00
  ❌ charity split: $45.00 (expected $60.00)
  ❌ Infrastructure split: $30.00 (expected $30.00)
  ❌ Founder split: $25.00 (expected $10.00)

GLOBAL SPLIT VIOLATIONS:
  ❌ Global charity split: 48.50% (expected 60.00%)
  ❌ Global Founder split: 21.50% (expected 10.00%)
```
...
- Verified pediatric charities receive 60% of every agent sold (Gospel V1.3)
