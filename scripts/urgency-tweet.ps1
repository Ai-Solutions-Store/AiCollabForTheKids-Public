# Twitter OAuth 1.0a - Urgency Tweet
...
$TweetText = @"
While we debate, kids wait.

$100k goal = $60k to pediatric charities.
Not someday. The moment we hit it.

Every backer = real impact.
Every share = more kids helped.
