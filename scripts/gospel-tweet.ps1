# Twitter OAuth 1.0a - Gospel V1.3 Tweet
...
$TweetText = @"
Most platforms take 20-30% for themselves. We take 10%.

Why? The founder moved 10% of HIS share to the kids.

60% goes to pediatric charities - the highest split in charitable e-commerce.

Back us: https://jules-dashboard.pages.dev/kickstarter

#ForTheKids #CharityTech
"@
