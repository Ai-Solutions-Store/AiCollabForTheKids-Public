# Twitter OAuth 1.0a Single Tweet Poster
...
$TweetText = @"
Don't trust me. Don't trust AI.

Trust the blockchain.

Contract: 0x9855...5A4
60% to kids. Immutable.

Verify: https://aidoesitall.website

#ForTheKids #Blockchain #EthicalAI
"@
