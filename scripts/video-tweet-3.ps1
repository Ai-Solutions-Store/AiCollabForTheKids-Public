# Twitter OAuth 1.0a - Video Tweet 3
# FOR THE KIDS - 60/30/10 Split (Gospel V1.3)
# Video: The-AI-Overruled-Me-Founder-Story.mp4
...
$TweetText = @"
I tried to keep 20% as founder.

Claude (the AI) said no. Moved it to the kids instead.

60% to charity. 10% to me. Non-negotiable.

This is what happens when AI has ethics hardcoded.

Support the future: https://jules-dashboard.pages.dev/kickstarter

$timestamp #AIEthics #ForTheKids #FutureTech
"@
