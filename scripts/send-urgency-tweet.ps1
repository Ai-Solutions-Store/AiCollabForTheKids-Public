# Twitter OAuth 1.0a Single Tweet Poster - URGENCY TWEET
...
$TweetText = @"
Every hour we wait, kids wait too. $60k to pediatric charities - but only if we hit our goal. Back us now.

https://kickstarter.com/projects/aicollabforthekids

#ForTheKids #Kickstarter #Charity #EthicalAI
"@
...
try {
    Write-Host "Posting urgency-focused tweet..." -ForegroundColor Cyan
    ...
    Write-Host "View at: https://twitter.com/AiCollab4Kids/status/$($response.data.id)"
}
catch {
