# Twitter OAuth 1.0a - Founder Story Tweet
...
$TweetText = @"
I took a pay cut so kids get more.

Gospel V1.3: I moved 10% from MY share to theirs.

Old: 50/30/20
New: 60/30/10

$60,000 to pediatric charities.
Not a pledge. Hardcoded.
