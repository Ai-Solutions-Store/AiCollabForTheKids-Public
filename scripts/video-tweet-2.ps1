# Twitter OAuth 1.0a - Video Tweet 2
# FOR THE KIDS - 60/30/10 Split (Gospel V1.3)
# Video: Verify-Donation-On-Chain-Proof.mp4
...
$TweetText = @"
"Trust us" doesn't work for charity anymore.

That's why EVERY donation is verifiable on-chain.
0x9855B75061D4c841791382998f0CE8B2BCC965A4

See exactly where your money goes. No faith required.

Join the movement: https://jules-dashboard.pages.dev/kickstarter

$timestamp #Blockchain #Transparency #ForTheKids
"@
