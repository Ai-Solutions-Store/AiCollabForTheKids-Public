...
const GOSPEL_BRAND = {
    ...
    split: {
        charity: 60,  // Gospel V1.3
        infrastructure: 30,
        founder: 10   // Gospel V1.3
    },
    messaging: {
        core: '60% of NET profits automatically allocated to verified pediatric charities (Gospel V1.3)',
...
3. The 60% split is a TECHNICAL DIVIDEND of efficient systems, not generosity
