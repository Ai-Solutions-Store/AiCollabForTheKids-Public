...
// PreorderKickstarter removed - consolidated into ImpactTracker
...
const App: React.FC = () => {
    ...
    const renderView = () => {
        switch (view) {
            ...
            case 'store':
                // Redirect to AI Solutions Store
                window.open('https://ai-solutions.store', '_blank');
                return <ComingSoon viewName="AI Solutions Store" icon={Image} description="Premium AI tools and solutions - opening in new tab." category="Ventures" />;
