...
const DatingPlatform: React.FC = () => {
  ...
  const fetchStats = async () => {
    try {
      const apiUrl = import.meta.env.VITE_API_URL || 'https://api.aidoesitall.website';
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-800/50 border border-white/10 rounded-xl p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                <div className="w-24 text-right text-slate-400 text-sm">10%</div>
                <div className="flex-1">
                  <div className="h-8 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center px-4" style={{ width: '20%' }}>
