 ...
 * - 60/30/10 split breakdown (Gospel V1.3)
...
export default function Transparency() {
  ...
  const calculateSplit = (revenue) => ({
    charity: revenue * 0.60,
    infrastructure: revenue * 0.30,
    founder: revenue * 0.10
  });
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              ...
              <div className="p-4 bg-purple-100 rounded-lg">
                ...
                <div className="text-sm text-gray-600">Founder (Gospel V1.3)</div>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="border-t-2 pt-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="p-4 bg-purple-100 rounded-lg">
                  <div className="text-sm text-gray-600 mb-1">Founder (10%)</div>
