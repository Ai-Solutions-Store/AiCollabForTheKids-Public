  ...
  useEffect(() => {
    const fetchRevenueData = async () => {
      try {
        ...
        // Calculate Gospel V1.3 split from NET profit (60/30/10 - Kids get MORE)
        const totalRevenue = data.totalRevenue || 0;
        const charityAllocated = Math.floor(totalRevenue * 0.60);
        const infrastructureAllocated = Math.floor(totalRevenue * 0.30);
        const founderAllocated = Math.floor(totalRevenue * 0.10);
